...
$companyQuery = "SELECT terms_uroam FROM company_profile LIMIT 1";
...
$termsContent = $company['terms_uroam'] ?? 'Content not available';
?>
<!DOCTYPE html>
<html lang="en">
